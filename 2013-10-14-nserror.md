...
Good news are [@shoumikhin](https://github.com/shoumikhin) managed to compile all these and much more error descriptions into one simple [`NSError` category](https://github.com/shoumikhin/NSXtensions/blob/master/NSErrorX.m).

And now you can get a lot of standard human-readable error descriptions with [`myError.friendlyLocalizedDescription`](https://github.com/shoumikhin/NSXtensions/blob/master/NSErrorX.h#L18).
