...
One the features most sorely lacking in Foundation was the ability to work with units for quantities like mass or length. In iOS 8 and OS X Yosemite, three new classes were introduced that fill the gap: `NSEnergyFormatter`, `NSMassFormatter`, & `NSLengthFormatter`.
