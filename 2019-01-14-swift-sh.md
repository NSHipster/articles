...
```swift
import DeckOfPlayingCards // apple/example-package-deckofplayingcards ~> 3.0.4
```
...
{% info %}
For what it's worth,
we would have used a [fork](https://github.com/NSHipster/DeckOfPlayingCards) regardless
