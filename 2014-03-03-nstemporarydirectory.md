...
Alternatively, `NSUUID` ([discussed previously](https://nshipster.com/uuid-udid-unique-identifier)) also produces workable results, assuming that you're not doing anything _too_ crazy.
