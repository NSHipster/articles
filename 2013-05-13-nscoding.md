...
<table class="core-data-versus-nskeyedarchiver">
  <thead>
    <tr>
      <th></th>
      <th>Core Data</th>
...
While it is not advisable to store an entire object graph into `NSUserDefaults`, it can be useful to encode compound objects, such as API credentials or "current user" objects in this way.
